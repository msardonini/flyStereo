...
TEST(fly_stereo_interop, IMU) {
  ...
  mavlink_imu_t packet_c{93372036854775807ULL, 963497880, 963498088, 129.0, 157.0, 185.0, {213.0, 214.0, 215.0},
                         {297.0, 298.0, 299.0}};
...
TEST(fly_stereo_interop, RESET_COUNTERS) {
  ...
  mavlink_reset_counters_t packet_c{93372036854775807ULL};
...
TEST(fly_stereo_interop, COMMAND) {
  ...
  mavlink_command_t packet_c{93372036854775807ULL, 963497880, 963498088, 963498296, 65, 132};
...
TEST(fly_stereo_interop, VIO) {
  ...
  mavlink_vio_t packet_c{93372036854775807ULL, {73.0, 74.0, 75.0}, {157.0, 158.0, 159.0}, {241.0, 242.0, 243.0, 244.0}};
