...
static inline uint16_t mavlink_msg_reset_counters_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
  ...
  return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_RESET_COUNTERS_MIN_LEN,
                                  MAVLINK_MSG_ID_RESET_COUNTERS_LEN, MAVLINK_MSG_ID_RESET_COUNTERS_CRC);
}
...
static inline uint16_t mavlink_msg_reset_counters_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
  ...
  msg->msgid = MAVLINK_MSG_ID_RESET_COUNTERS;
  return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_RESET_COUNTERS_MIN_LEN,
                                       MAVLINK_MSG_ID_RESET_COUNTERS_LEN, MAVLINK_MSG_ID_RESET_COUNTERS_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_reset_counters_encode(uint8_t system_id, uint8_t component_id,
                                                         mavlink_message_t* msg,
                                                         const mavlink_reset_counters_t* reset_counters) {
 ...
 * @param reset_counters C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_reset_counters_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                                                              mavlink_message_t* msg,
                                                              const mavlink_reset_counters_t* reset_counters) {
...
static inline void mavlink_msg_reset_counters_send(mavlink_channel_t chan, uint64_t timestamp_us) {
  ...
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RESET_COUNTERS, buf, MAVLINK_MSG_ID_RESET_COUNTERS_MIN_LEN,
                                  MAVLINK_MSG_ID_RESET_COUNTERS_LEN, MAVLINK_MSG_ID_RESET_COUNTERS_CRC);
#else
  mavlink_reset_counters_t packet;
  packet.timestamp_us = timestamp_us;

  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RESET_COUNTERS, (const char*)&packet,
                                  MAVLINK_MSG_ID_RESET_COUNTERS_MIN_LEN, MAVLINK_MSG_ID_RESET_COUNTERS_LEN,
                                  MAVLINK_MSG_ID_RESET_COUNTERS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_reset_counters_send_struct(mavlink_channel_t chan,
                                                          const mavlink_reset_counters_t* reset_counters) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
  mavlink_msg_reset_counters_send(chan, reset_counters->timestamp_us);
#else
  _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RESET_COUNTERS, (const char*)reset_counters,
                                  MAVLINK_MSG_ID_RESET_COUNTERS_MIN_LEN, MAVLINK_MSG_ID_RESET_COUNTERS_LEN,
                                  MAVLINK_MSG_ID_RESET_COUNTERS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_reset_counters_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan,
                                                       uint64_t timestamp_us) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline void mavlink_msg_reset_counters_decode(const mavlink_message_t* msg,
                                                     mavlink_reset_counters_t* reset_counters) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
