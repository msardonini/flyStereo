...
static inline uint16_t mavlink_msg_command_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t timestamp_us, uint8_t engage, uint8_t shutdown, uint32_t custom_cmd1, uint32_t custom_cmd2, uint32_t custom_cmd3)
{
...
{
    return mavlink_msg_command_pack(system_id, component_id, msg, command->timestamp_us, command->engage, command->shutdown, command->custom_cmd1, command->custom_cmd2, command->custom_cmd3);
}
...
{
    return mavlink_msg_command_pack_chan(system_id, component_id, chan, msg, command->timestamp_us, command->engage, command->shutdown, command->custom_cmd1, command->custom_cmd2, command->custom_cmd3);
}
...
static inline void mavlink_msg_command_send(mavlink_channel_t chan, uint64_t timestamp_us, uint8_t engage, uint8_t shutdown, uint32_t custom_cmd1, uint32_t custom_cmd2, uint32_t custom_cmd3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_COMMAND_LEN];
    _mav_put_uint64_t(buf, 0, timestamp_us);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_command_send(chan, command->timestamp_us, command->engage, command->shutdown, command->custom_cmd1, command->custom_cmd2, command->custom_cmd3);
#else
 ...
 */
static inline void mavlink_msg_command_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t timestamp_us, uint8_t engage, uint8_t shutdown, uint32_t custom_cmd1, uint32_t custom_cmd2, uint32_t custom_cmd3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
