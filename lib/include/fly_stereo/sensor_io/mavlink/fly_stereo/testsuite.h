...
static void mavlink_test_imu(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg) {
  ...
  uint16_t i;
  mavlink_imu_t packet_in = {93372036854775807ULL, 963497880, 963498088, 129.0, 157.0, 185.0, {213.0, 214.0, 215.0},
                             {297.0, 298.0, 299.0}};
  ...
  memset(&packet2, 0, sizeof(packet2));
  mavlink_msg_imu_pack(system_id, component_id, &msg, packet1.timestamp_us, packet1.time_since_trigger_us,
                       packet1.trigger_count, packet1.roll, packet1.pitch, packet1.yaw, packet1.gyroXYZ,
                       packet1.accelXYZ);
  mavlink_msg_imu_decode(&msg, &packet2);
  MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

  memset(&packet2, 0, sizeof(packet2));
  mavlink_msg_imu_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg, packet1.timestamp_us,
                            packet1.time_since_trigger_us, packet1.trigger_count, packet1.roll, packet1.pitch,
                            packet1.yaw, packet1.gyroXYZ, packet1.accelXYZ);
  mavlink_msg_imu_decode(&msg, &packet2);
  MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
  ...
  memset(&packet2, 0, sizeof(packet2));
  mavlink_msg_imu_send(MAVLINK_COMM_1, packet1.timestamp_us, packet1.time_since_trigger_us, packet1.trigger_count,
                       packet1.roll, packet1.pitch, packet1.yaw, packet1.gyroXYZ, packet1.accelXYZ);
  mavlink_msg_imu_decode(last_msg, &packet2);
  MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_reset_counters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg) {
  ...
  uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
  uint16_t i;
  mavlink_reset_counters_t packet_in = {93372036854775807ULL};
  ...
  if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
    // cope with extensions
    memset(MAVLINK_MSG_ID_RESET_COUNTERS_MIN_LEN + (char *)&packet1, 0,
           sizeof(packet1) - MAVLINK_MSG_ID_RESET_COUNTERS_MIN_LEN);
  }
#endif
  memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_command(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg) {
  ...
  uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
  uint16_t i;
  mavlink_command_t packet_in = {93372036854775807ULL, 963497880, 963498088, 963498296, 65, 132};
  ...
  memset(&packet2, 0, sizeof(packet2));
  mavlink_msg_command_pack(system_id, component_id, &msg, packet1.timestamp_us, packet1.engage, packet1.shutdown,
                           packet1.custom_cmd1, packet1.custom_cmd2, packet1.custom_cmd3);
  mavlink_msg_command_decode(&msg, &packet2);
  MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

  memset(&packet2, 0, sizeof(packet2));
  mavlink_msg_command_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg, packet1.timestamp_us, packet1.engage,
                                packet1.shutdown, packet1.custom_cmd1, packet1.custom_cmd2, packet1.custom_cmd3);
  mavlink_msg_command_decode(&msg, &packet2);
  MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
  ...
  memset(&packet2, 0, sizeof(packet2));
  mavlink_msg_command_send(MAVLINK_COMM_1, packet1.timestamp_us, packet1.engage, packet1.shutdown, packet1.custom_cmd1,
                           packet1.custom_cmd2, packet1.custom_cmd3);
  mavlink_msg_command_decode(last_msg, &packet2);
  MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_vio(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg) {
  ...
  memset(&packet2, 0, sizeof(packet2));
  mavlink_msg_vio_pack(system_id, component_id, &msg, packet1.timestamp_us, packet1.position, packet1.velocity,
                       packet1.quat);
  mavlink_msg_vio_decode(&msg, &packet2);
  MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

  memset(&packet2, 0, sizeof(packet2));
  mavlink_msg_vio_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg, packet1.timestamp_us, packet1.position,
                            packet1.velocity, packet1.quat);
  mavlink_msg_vio_decode(&msg, &packet2);
  MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
